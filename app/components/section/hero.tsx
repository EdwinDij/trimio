    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex justify-center gap-6 items-center max-sm:flex-col max-sm:gap-10">
          <Link
            href="#contact"
            className="bg-amber-500/90 text-[#102a47] px-6 py-3 rounded-full font-semibold hover:bg-amber-500/70 transition-colors"
          >
            Démarrer un projet
          </Link>
          <Link
            href="#services"
            className="flex items-center gap-2 bg-transparent border px-6 py-3 rounded-full font-semibold text-white hover:bg-white/10 transition-colors"
          >
            <LucidePlayCircle/>Démarrer un projet
          </Link>
        </div>
      </div>
    </section>
